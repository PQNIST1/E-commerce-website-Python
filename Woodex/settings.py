"""
Django settings for Woodex project.
...
SECRET_KEY = 'django-insecure--8@)a8*(#w-hg--hr5tc_(=pl5_oa(q-x$zlg!5!54!wa+^u%3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Cấu hình CORS cho phép các domain khác gọi API
# Lưu ý: Update lại sau khi deploy lên production
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',
     'Woodex.middleware.prevent_login_signup.PreventLoginSignupMiddleware',
]

ROOT_URLCONF = 'Woodex.urls'
...
WSGI_APPLICATION = 'Woodex.wsgi.application'
